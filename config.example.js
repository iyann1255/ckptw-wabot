...
global.config = {
    ...
    bot: {
        ...
        phoneNumber: "6289654275485", // Nomor telepon bot (opsional jika menggunakan QR code)
    ...
    // Informasi owner bot
    owner: {
        name: "asepp", // Nama owner bot
        organization: "CKAI", // Nama organisasi owner bot
        id: "62895167204", // Nomor telepon owner bot
